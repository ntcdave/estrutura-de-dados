public class SomaMatrizes {
    ...
    public static void main(String[] args) {
        // Defina as matrizes que você deseja somar
        int[][] matrizA = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
        int[][] matrizB = {{9, 8, 7}, {6, 5, 4}, {3, 2, 1}};

        // Verifique se as matrizes têm as mesmas dimensões
        if (matrizA.length != matrizB.length || matrizA[0].length != matrizB[0].length) {
            System.out.println("As matrizes têm dimensões diferentes. Não é possível realizar a soma.");
            return;
        }

        // Crie uma matriz para armazenar a soma
        ...
        // Exiba a matriz resultante (soma)
